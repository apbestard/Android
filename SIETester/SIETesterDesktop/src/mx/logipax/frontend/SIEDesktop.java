...
public class SIEDesktop extends SIEMain {
    ...
    static String VERSION = "Ver 1.11";
    static String SSTUBVERSION = "1.00";
    static String SHOME = "_logipax/";
    static String SENV = "";
    static String SURL = "http://tester.logipax.com.mx:8080";
    static String SMURL = "http://tester.logipax.com.mx:8080";
    static String SNAME = "Sistema de Información Ejecutiva";
    static String SDISPATCHER = "/LPXSIETesterViewerService/WS";
    static String SMAILER = "/SIEV12Mailer/Mailer";
    static String SSYNC = "/SIEV1Sync";
    static String SEXE = "SIEPROACorpDesktop.jar";
...
//                }
    ...
    public Profile profile(FEMain main) {
        ...
        login = new FELogin(main, "", "", profile, "Control de Acceso");
