...
public class CardEquiposFrom extends ModelessJPanel implements ParentFormInterfase {

    private FEMain main;
    private IDELogipax frame;
    private CardEquiposFrom panel;
...
//    private Editable femail;
    private String id = "";
    private EquiposTable t01;
    private EquiposRec r01;
    private EquiposTable t02;
    private EquiposRec r02;
    
    public CardEquiposFrom(FEMain main, IDELogipax frame, String name, String function, CardSuc rrecord2, FormInterfase form, String creador, boolean edit, int cardLevel, String cardId) {
        ...
        r01 = new EquiposRec(frame);
        t01 = new EquiposTable(main, frame, name, this, id, r01, r01.getHeaders(), r01.getHeadersJustify(), addrow, 0, rfcicons);
...
//        fresponsable.setEditable(!noedit);
    ...
    private void initComponents() {
        ...
        tabpn.setBorder(javax.swing.BorderFactory.createTitledBorder("Equipos"));
