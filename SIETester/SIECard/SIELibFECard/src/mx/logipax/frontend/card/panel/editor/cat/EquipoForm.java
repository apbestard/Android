...
public class EquipoForm extends ModalJPanel {

    private FEMain main;
    private IDELogipax frame;
    private EquipoForm panel;
    private String function;
    private EquiposRec rrecords;
    private ParentFormInterfase form;
    private EquipoRec rrecord;
    private CardSucEquipo inidata = null;
    private boolean started = false;
    private String creador = "";
    private boolean edit = false;
    private boolean displayed = false;
    private EditCombo fdeptcb;
    private EditCombo fequipocb;
    private Editable fpers;
    private Editable fvacs;
    private EditableDate faper;

    public EquipoForm(FEMain main, IDELogipax frame, String name, String function, EquiposRec rrecords, EquipoRec rrecord, ParentFormInterfase form, String creador, boolean edit, ModalParentInterfase parent, int id) {
    ...
    private void create() {
        ...
        fequipocb = new EditCombo(frame, this, "Departamento", eqcb, null, new String[]{}, "Seleccione el Puesto", null, error);
        main.getAsync().enqueueJob(new Runnable() {
            public void run() {
                ...
                CatalogUtility.loadTabla(frame, main.getURL(), main.getDispatcher(), main.getTicket(), true, "equipo", "", "", fequipocb, error);
                frame.waitingPop();
            }
        });
        fpers = new Editable(frame, this, "No Equipos", pers, null, "Ingrese el No de Equipos", null, error);
    ...
    private void get0(final String responsableId) {
        error.setText(null);
        final CardSucEquipo rrecord = new CardSucEquipo(new JSONObject());
...
//                refresh();
    ...
    private void update() {
        ...
        rrecord.getRecord().setEquipoId(CatalogUtility.getKey(fequipocb.get()));
...
//        }
        ...
        rrecord = new EquipoRec(frame, rrecords, id, inidata);
        return rrecord != null;
    }
    ...
    private void initComponents() {
            ...
            .add(pnLayout.createSequentialGroup()
                ...
                .add(pnLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                    ...
                    .add(pnLayout.createSequentialGroup()
                        .add(eqlb)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(eqcb, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 305, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                    .add(pnLayout.createSequentialGroup()
                        .add(pnLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                            .add(pnLayout.createSequentialGroup()
                                .add(perslb)
        ...
        pnLayout.setVerticalGroup(
            ...
            .add(pnLayout.createSequentialGroup()
                ...
                .add(pnLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(eqlb)
                    .add(eqcb, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(pnLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(perslb)
    ...
    private void okActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okActionPerformed
        ...
        if (function.equals(DlgProcessing.SHW)) {
            ...
            int response = JOptionPane.showConfirmDialog(frame.getFrame(), "¿Eliminar Equipo " + msg + "?", "Eliminar", JOptionPane.YES_NO_OPTION);
    ...
    private javax.swing.JLabel eqlb;
