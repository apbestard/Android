...
public class BECardSuc00Equipos implements BEObject {
    ...
    public BECardSuc00Equipos(BEServletInterfase servlet) {
    ...
    public boolean match(String command) {
        return command.equals("cardsucequipos");
    }
    ...
    public String[] responseText(String command, JSONObject input) {
        ...
        DB2CatUpd db_cat1 = new DB2CatUpd(servlet.db(), "local", 0, db_persona);
